...
const presets: Preset[] = [
  {
    id: 'apple-mobile-clear',
    name: 'Apple 移动端清晰',
    description: 'PingFang SC 双语，英文极淡黄，适合 iPhone/移动端横屏。',
    options: { ...defaultOptions, chineseFont: 'PingFang SC', englishFont: 'PingFang SC', chineseSize: 20, englishSize: 12, primaryColor: '&H00FFFFFF', englishColor: '&H00CCF4FF', outline: 1, shadow: 1 },
  },
  {
    id: 'yahei-arial-classic',
    name: '雅黑 + Arial 经典',
    description: 'Windows/电视盒兼容思路：微软雅黑中文、Arial 英文，白字细黑边。',
    options: { ...defaultOptions, chineseFont: 'Microsoft YaHei', englishFont: 'Arial', chineseSize: 20, englishSize: 12, primaryColor: '&H00FFFFFF', englishColor: '&H00FFFFFF', outlineColor: '&H000000', outline: 1, shadow: 1 },
  },
  {
    id: 'source-han-noto-balanced',
    name: '思源黑体 + Noto',
    description: '跨平台开源字体组合，中文思源黑体，英文 Noto Sans，层级干净。',
    options: { ...defaultOptions, chineseFont: 'Source Han Sans SC', englishFont: 'Noto Sans', chineseSize: 20, englishSize: 12, primaryColor: '&H00F5F5F5', englishColor: '&H00DCDCDC', outline: 0.9, shadow: 0 },
  },
  {
    id: 'helvetica-cinema',
    name: 'Helvetica 电影感',
    description: '接近现代影视字幕：中文用苹方，英文 Helvetica Neue，暖白/浅灰。',
    options: { ...defaultOptions, chineseFont: 'PingFang SC', englishFont: 'Helvetica Neue', chineseSize: 20, englishSize: 12, primaryColor: '&H00F5F5F5', englishColor: '&H00DCDCDC', outline: 0.8, shadow: 0 },
  },
  {
    id: 'yellow-main-white-en',
    name: '黄主白英双语',
    description: '中文极淡黄突出主阅读，英文白色较小，适合双语学习。',
    options: { ...defaultOptions, chineseFont: 'Microsoft YaHei', englishFont: 'Helvetica Neue', chineseSize: 21, englishSize: 12, primaryColor: '&H00CCF4FF', englishColor: '&H00FFFFFF', outline: 1, shadow: 1 },
  },
  {
    id: 'white-main-yellow-en',
    name: '白主黄英双语',
    description: '中文白色，英文极淡黄，兼顾主字幕稳定和英文辨识。',
    options: { ...defaultOptions, chineseFont: 'PingFang SC', englishFont: 'Arial', chineseSize: 20, englishSize: 12, primaryColor: '&H00FFFFFF', englishColor: '&H00CCF4FF', outline: 1, shadow: 1 },
  },
  {
    id: 'desktop-bold-readable',
    name: '桌面大字清晰',
    description: '电脑/投屏用：字号更大，Noto Sans CJK + Arial，描边略强。',
    options: { ...defaultOptions, chineseFont: 'Noto Sans CJK SC', englishFont: 'Arial', chineseSize: 24, englishSize: 14, primaryColor: '&H00FFFFFF', englishColor: '&H00CCF4FF', outlineColor: '&H000000', outline: 1.3, shadow: 1 },
  },
  {
    id: 'ios-soft-no-shadow',
    name: 'iOS 柔边无阴影',
    description: '减少移动端锯齿：苹方 + Helvetica，细描边，无阴影。',
    options: { ...defaultOptions, chineseFont: 'PingFang SC', englishFont: 'Helvetica Neue', chineseSize: 20, englishSize: 12, primaryColor: '&H00F5F5F5', englishColor: '&H00DCDCDC', outlineColor: '&H4A4A4A', outline: 0.5, shadow: 0 },
  },
  {
    id: 'bright-scene-strong',
    name: '亮场强可读',
    description: '白字黑边，描边稍强，适合画面偏亮或背景复杂。',
    options: { ...defaultOptions, chineseFont: 'Microsoft YaHei', englishFont: 'Arial', chineseSize: 21, englishSize: 13, primaryColor: '&H00FFFFFF', englishColor: '&H00CCF4FF', outlineColor: '&H000000', outline: 1.3, shadow: 1 },
  },
  {
    id: 'learning-high-contrast',
    name: '学习高对比',
    description: '中文暖白、英文暖黄，英文字号略大，适合跟读学习。',
    options: { ...defaultOptions, chineseFont: 'Source Han Sans SC', englishFont: 'Helvetica Neue', chineseSize: 20, englishSize: 14, primaryColor: '&H00F5F5F5', englishColor: '&H00A8E9FF', outlineColor: '&H000000', outline: 1.1, shadow: 1 },
  },
];
